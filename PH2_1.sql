...
(
    ...
    TUYEN VARCHAR2(30) NOT NULL,
    VUNG VARCHAR2(30) NOT NULL,
    CONSTRAINT PK_CSYT PRIMARY KEY(MA_CSYT),
    CONSTRAINT CONS_TUYEN CHECK (TUYEN IN('Điều trị ngoại trú', 'Điều trị nội trú', 'Điều trị chuyên sâu')),
    CONSTRAINT CONS_VUNG CHECK (VUNG IN('Trung tâm', 'Cận trung tâm', 'Ngoại thành'))
);
